    ...
    <div class="container">
        ...
        <div class="mis-hijos-section">
            <div class="section-header">
                ...
                <a href="<?php echo URL_BASE; ?>/vistas/padre/mis-hijos/inscribir.php" class="btn btn-primary">➕ Inscribir Nuevo Hijo</a>
            </div>
                    ...
                    <?php foreach ($mis_hijos as $hijo): ?>
                        <div class="hijo-card">
                            ...
                            <div class="hijo-actions">
                                <a href="<?php echo URL_BASE; ?>/vistas/padre/mis-hijos/detalle.php?id=<?php echo $hijo['id_campista']; ?>" 
                                   class="btn btn-primary btn-small">
                                    Ver Detalle
                                </a>
                                <a href="<?php echo URL_BASE; ?>/vistas/padre/mis-hijos/editar.php?id=<?php echo $hijo['id_campista']; ?>" 
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <a href="<?php echo URL_BASE; ?>/vistas/padre/mis-hijos/inscribir.php" class="btn btn-primary">
