...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .action-card { background: white; padding: 30px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); text-align: center; text-decoration: none; transition: all 0.3s; border: 2px solid transparent; display: block; color: #333; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="actions-grid">
            ...
            <a href="<?php echo URL_BASE; ?>/vistas/padre/actividades/calendario.php" class="action-card">
                <h3>🎯 Actividades</h3>
            </a>
        </div>
        ...
        <div class="mis-hijos-section">
            <div class="section-header">
                ...
                <a href="<?php echo URL_BASE; ?>/vistas/padre/mis-hijos/inscribir.php" class="btn btn-primary">➕ Nuevo Registro</a>
            </div>
                    ...
                    <?php foreach ($mis_hijos as $hijo): ?>
                        <div class="hijo-card">
                            ...
                            <div class="hijo-actions">
                                <a href="<?php echo URL_BASE; ?>/vistas/padre/mis-hijos/detalle.php?id=<?php echo $hijo['id_campista']; ?>" class="btn btn-primary btn-small">Ver Detalle</a>
                                <a href="<?php echo URL_BASE; ?>/vistas/padre/mis-hijos/editar.php?id=<?php echo $hijo['id_campista']; ?>" class="btn btn-small" style="background: #e2e8f0; color: #333;">Editar</a>
                                
                                <?php if ($hijo['estado_inscripcion'] !== INSCRIPCION_APROBADO): ?>
                                    <form action="<?php echo URL_BASE; ?>/vistas/padre/mis-hijos/eliminar.php" method="POST" onsubmit="return confirm('¿Retirar inscripción?');">
